class Vehicle{
    ...
    display(){
        ...
        if (this.color == 0){
            ...
            if (this.origin.x == 0 && this.origin.y == 0) {
                    ...
                    ellipse(this.position.x,(-array_band2[99]+array_band_hardcode[99]+75-array_band_hardcode[99]-this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3)*s_y,5)
            ...
            // ellipse(630*s_x,200*s_y,20)
             ...
             if (this.origin.x == 0 && this.origin.y == 0) {
                ...
                strokeWeight(1);
                ellipse(this.position.x,-7+144*s_y+this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3,5)
             } else {
                noFill();
                stroke(125, 241, 148,  100); //green
                strokeWeight(1);
                ellipse(this.position.x,-7+(this.origin.y-155.7)+144*s_y+this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3,5)
    ...
    accelerate() {
    //     if ((this.position.x > ((550-(400)/8*count_pn_num))*s_x) && (this.position.x < ((550+(400)/8*count_pn_num))*s_x)) {
    ...
    //         this.acceleration = e_field_c/170*factor_new ;
