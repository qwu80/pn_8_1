...
if (isOn ==false) {
//right up 
rect((550)*s_x,(10+385/2+96.25)*s_y,((400)/8*X_n)*s_x, -rect_density*4*s_y)
//left down
rect((550)*s_x,(10+385/2+96.25)*s_y,-((400)/8*X_n)*s_x, rect_density*4*s_y)
...
//E- field 
if (isOn==true){
  triangle((550-(400)/8*X_n)*s_x, (10+385/2+96.25)*s_y, (550+(400)/8*X_n)*s_x, (10+385/2+96.25)*s_y, (550)*s_x, (10+385/2+96.25+  2*rect_density/(X_n*100)*200*2)*s_y)
...
for (var i = 0; i<100; i++) {
  ...
  //(800)/100*i
  if ((800)/100*i>(550-(400)/8*X_n) && (800)/100*i<(550)){
    array_band1[i-19]= -Math.pow(((800)/100*i-(550-(400)/8*X_n))/((400)/8*X_n)*(2*rect_density/(X_n*100)*177*2) ,1)/5/3
  }  else if (i==50) {
    // array_band1[50]= Math.pow((2*rect_density/(X_n*100)*count_n*2),2)/20
  } else {
    array_band1[i]= 0
...
for (var i = 0; i<100; i++) {
  ...
  if (i>50) {
    ...
    array_band1[i]=  -Math.pow((2*rect_density/(X_n*100)*177*2) ,1)/5/3
  }
//  triangle((550-(400)/8*count_pn_num)*s_x, (10+385/2+96.25)*s_y, (550+(400)/8*count_pn_num)*s_x, (10+385/2+96.25)*s_y, (550)*s_x, (10+385/2+96.25+  2*rect_density/(X_n*100)*count_n*2)*s_y)
